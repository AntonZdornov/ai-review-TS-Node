...
from .utils import format_report_text
...
def main():
    ...
    ap.add_argument("--model", default="qwen2.5-coder:7b", help="Model name override")
    ap.add_argument("--base-url", dest="base_url", default="http://127.0.0.1:11434/v1", help="OpenAI-compatible base URL for local models")
    ...
    base_url = (args.base_url or None) if args.provider != "openai" else None
